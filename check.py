print("[+]EMAIL Valid Email Checker by BONUMMASTER.PH[+]")
import requests
live = open('PayPalLive.txt', 'w')
die = open('PayPalDie.txt', 'w')
Checked = "Checked by BONUMMASTER.PH Valid Email Checker"
print("_"*50)
print"PayPal Valid Email Checker by BONUMMASTER.PH"
print"I dont't Accept any Responsibility for any illegal usage!"
print("_"*55)
print" "
list=raw_input("Input Mail List :")
link = "https://mmo69.com/_check_live_email/index.php"
...
print("PayPal Valid Email was Saved in BONUMEMAILCHECK.txt")
